...
// Default to handling a product order (no customization)
if (isset($_POST['product_id'])) {
...
} elseif (isset($_GET['customization_id'])) {
    ...
    $total_price = $customization['base_price'] * $customization['tiers']; // Simple price calculation
}
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4" style="color: #d6336c;">Order Summary</h1>
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="order-summary">
                    <h5 class="mb-4" style="color: #d6336c;">Order Details</h5>
                    ...
                    <form action="" method="POST" class="mt-4">
                        ...
                        <button type="submit" name="submit_order" class="btn btn-primary w-100" style="background-color: #d6336c; border-color: #d6336c;">Proceed to Payment</button>
                    </form>
                </div>
            </div>
        </div>
